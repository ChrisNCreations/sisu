...
/// @dev Vendored copy of `@1inch/swap-vm/test/utils/ProgramBuilder.sol`. Production contracts must not
///      depend on a package's test tree; the logic is pure and inlined, so bytecode is unchanged.
